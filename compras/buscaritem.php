...
if ($action == 'ajax') {
    $aColumns = array('descripcion'); // Columnas para buscar
    $sTable = 'articulos'; // Tabla para consultar
    $sWhere = ' WHERE idArticulo > 0 '; // Condición de la base
    ...
    $per_page = 5; // Registros por pagina
    $adjacents = 2; // Enlaces alrededor de la página actual en la paginación
    ...
    round(`articulos`.`preciocompra`, 0) as preciocompra,
